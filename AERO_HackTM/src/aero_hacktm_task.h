  ...
  namespace AERO_HACK_TM_Task
  {
	...
	class CModPlugIn : public CEvtPlugIn
    {
      ...
      private:
		...
		// ADAS up in the cloud stuff
 		std::unique_ptr<web::http::client::http_client> m_pHTTPClient;		//	(U("http://172.16.4.27:8000/payload"));
		std::unique_ptr<CRESTSender>					m_pRESTSender;
	 };	
  }
}
